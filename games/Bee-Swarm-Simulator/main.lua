...
local api = sleepy.returncode("https://raw.githubusercontent.com/philosolog/sleepy/main/Bee-Swarm-Simulator/api.lua")
...
miscc:CreateToggle("Godmode", nil, function(State) andromeda.toggles.godmode = State if State then bsssleepy:Godmode(true) else bsssleepy:Godmode(false) end end)
