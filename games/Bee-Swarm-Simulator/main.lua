...
miscc:CreateToggle("Godmode", nil, function(State) sleepy.toggles.godmode = State if State then bsssleepy:Godmode(true) else bsssleepy:Godmode(false) end end)
...
extras:CreateButton("Hide nickname", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/philosolog/sleepy/main/utilities/nicknamespoofer.lua"))()end)
