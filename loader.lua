...
local sleepyImageLabel = Instance.new("ImageLabel")
...
sleepyImageLabel.Name = "sleepyImageLabel"
sleepyImageLabel.Parent = MainFrame
sleepyImageLabel.AnchorPoint = Vector2.new(0.5, 0.5)
sleepyImageLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
sleepyImageLabel.BackgroundTransparency = 1.000
sleepyImageLabel.BorderSizePixel = 0
sleepyImageLabel.Position = UDim2.new(0.504000008, 0, 0.5, 0)
sleepyImageLabel.Size = UDim2.new(0, 250, 0, 250)
sleepyImageLabel.ZIndex = 3
sleepyImageLabel.Image = "http://www.roblox.com/asset/?id=0"
